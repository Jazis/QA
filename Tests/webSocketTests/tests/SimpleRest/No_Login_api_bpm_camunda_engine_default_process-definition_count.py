...
@allure.title("No login _api_bpm_camunda_engine_default_process-definition_count method check")
def test_start(debugLevel):
    debugEnable(int(debugLevel))
    link = "/api/bpm/camunda/engine/default/process-definition/count"
