...
from test.test_transactions.conftest import api_request_context, auth_token, CARD_WEEKLY, send_auth


@allure.title("Transaction declined check status, weekly")
def test_with_card_weekly_decline_check_status(api_request_context: APIRequestContext) -> None:
    ...
    response = api_request_context.get(
        '/api/transaction?card=247', headers=headers
    )
    ...
    api_post(api_request_context, n, CARD_WEEKLY, DECLINED, COUNTRY_GB, CURRENCY_USD)
...
@allure.title("Transaction auth + declined check status, weekly")
def test_with_card_weekly_auth_decline_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    auth = send_auth(api_request_context, n, CARD_WEEKLY, '7311')

    api_post_with_auth(api_request_context, auth, n, CARD_WEEKLY, DECLINED, COUNTRY_US, CURRENCY_USD)
...
@allure.title("Transaction auth + pending + settled check status, weekly")
def test_with_card_weekly_auth_pending_settled_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    api_post_pending_with_auth(api_request_context, auth, n, CARD_WEEKLY, PENDING, COUNTRY_US, CURRENCY_USD)
    ...
    api_post_with_auth(api_request_context, auth, n, CARD_WEEKLY, SETTLED, COUNTRY_US, CURRENCY_USD)
...
@allure.title("Transaction auth + pending + reversed check status, weekly")
def test_with_card_weekly_auth_pending_reversed_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    api_post_with_auth(api_request_context, auth, n, CARD_WEEKLY, REVERSAL, COUNTRY_US, CURRENCY_USD)
...
@allure.title("Transaction auth + pending + settled + refund check status, weekly")
def test_with_card_weekly_auth_pending_settled_refund_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    auth = send_auth(api_request_context, n, CARD_WEEKLY, '7311')
    api_post_pending_with_auth(api_request_context, auth, n, CARD_WEEKLY, PENDING, COUNTRY_GB, CURRENCY_USD)
    ...
    api_post_with_auth(api_request_context, auth, n, CARD_WEEKLY, SETTLED, COUNTRY_GB, CURRENCY_USD)
    ...
    api_post_with_auth(api_request_context, auth, n, CARD_WEEKLY, REFUND, COUNTRY_GB, CURRENCY_USD)
...
@allure.title("Transaction only auth, weekly")
def test_with_card_weekly_auth(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    send_auth(api_request_context, n, CARD_WEEKLY, '7311')
...
@allure.title("Transaction only settled check status, weekly")
def test_with_card_weekly_settled_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    api_request(api_request_context, n, CARD_WEEKLY, APPROVED_SUCCES, SETTLED, COUNTRY_GB, CURRENCY_USD)
...
@allure.title("Transaction auth settled check status, weekly")
def test_with_card_weekly_auth_settled_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    auth = send_auth(api_request_context, n, CARD_WEEKLY, '7311')
    api_post_with_auth(api_request_context, auth, n, CARD_WEEKLY, SETTLED, COUNTRY_GB, CURRENCY_EUR)
...
@allure.title("Transaction auth pending check status, weekly")
def test_with_card_weekly_auth_pending_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
...
@allure.title("Transaction auth reversed check status, weekly")
def test_with_card_weekly_auth_reversed_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
...
@allure.title("Transaction auth pending refund check status, weekly")
def test_with_card_weekly_auth_pending_refund_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
...
@allure.title("Transaction decline + auth check status, weekly")
def test_with_card_weekly_decline_auth_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    id = str(uuid.uuid4())
...
@allure.title("Transaction auth + settled + pending check status, weekly")
def test_with_card_weekly_auth_settled_pending_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
...
@allure.title("Transaction auth + reversed + pending check status, weekly")
def test_with_card_weekly_auth_reversed_pending_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    auth = send_auth(api_request_context, n, CARD_WEEKLY, '7311')
    api_post_with_auth(api_request_context, auth, n, CARD_WEEKLY, REVERSAL, COUNTRY_GB, CURRENCY_USD)
...
@allure.title("Transaction auth + pending + refund + settled check status, weekly")
def test_with_card_weekly_auth_pending_refund_settled_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    auth = send_auth(api_request_context, n, CARD_WEEKLY, '7311')
    api_post_pending_with_auth(api_request_context, auth, n, CARD_WEEKLY, PENDING, COUNTRY_GB, CURRENCY_EUR)
    ...
    api_post_with_auth(api_request_context, auth, n, CARD_WEEKLY, REFUND, COUNTRY_GB, CURRENCY_EUR)
...
@allure.title("Transaction auth + pending + reversed + settled check status, weekly")
def test_with_card_weekly_auth_pending_reversed_settled_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    api_post_with_auth(api_request_context, auth, n, CARD_WEEKLY, REVERSAL, COUNTRY_GB, CURRENCY_EUR)
...
@allure.title("Transaction auth + pending + settled + reversed check status, weekly")
def test_with_card_weekly_auth_pending_settled_reversed_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    auth = send_auth(api_request_context, n, CARD_WEEKLY, '7311')
    api_post_pending_with_auth(api_request_context, auth, n, CARD_WEEKLY, PENDING, COUNTRY_US, CURRENCY_EUR)
    ...
    api_post_with_auth(api_request_context, auth, n, CARD_WEEKLY, SETTLED, COUNTRY_US, CURRENCY_EUR)
    ...
    api_post_with_auth(api_request_context, auth, n, CARD_WEEKLY, REVERSAL, COUNTRY_US, CURRENCY_EUR)
...
@allure.title("Transaction only refund, weekly")
def test_with_card_weekly_only_refund(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    api_request(api_request_context, n, CARD_WEEKLY, APPROVED_SUCCES, REFUND, COUNTRY_US, CURRENCY_EUR)
...
@allure.title("Transaction auth + pending + refund + reversed check status, weekly")
def test_with_card_weekly_auth_pending_refund_reversed_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    auth = send_auth(api_request_context, n, CARD_WEEKLY, '7311')
    api_post_pending_with_auth(api_request_context, auth, n, CARD_WEEKLY, PENDING_REFUND, COUNTRY_US, CURRENCY_EUR)
...
def test_with_card_monthly_auth_pending_settled_reversed_issuerexpiration_check_status(api_request_context: APIRequestContext) -> None:
    ...
    api_post_with_auth(api_request_context, auth, n, CARD_WEEKLY, REVERSAL_EXPIRATION, COUNTRY_US, CURRENCY_EUR)
