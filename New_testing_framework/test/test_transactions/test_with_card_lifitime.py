...
from data.input_data.data_card import DECLINED, COUNTRY_GB, CURRENCY_USD, COUNTRY_US, PENDING, SETTLED, REVERSAL, REFUND, \
    CURRENCY_EUR, REVERSAL_EXPIRATION, PENDING_REFUND
...
from test.test_transactions.conftest import api_request_context, auth_token, CARD_LIFETIME, send_auth


@allure.title("Transaction declined check status, lifetime")
def test_with_card_lifetime_decline_check_status(api_request_context: APIRequestContext) -> None:
    ...
    response = api_request_context.get(
        '/api/transaction?card=246', headers=headers
    )
    ...
    api_post(api_request_context, n, CARD_LIFETIME, DECLINED, COUNTRY_GB, CURRENCY_USD)
...
@allure.title("Transaction auth + declined check status, lifetime")
def test_with_card_lifetime_auth_decline_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    auth = send_auth(api_request_context, n, CARD_LIFETIME, '7311')

    api_post_with_auth(api_request_context, auth, n, CARD_LIFETIME, DECLINED, COUNTRY_US, CURRENCY_USD)
...
@allure.title("Transaction auth + pending + settled check status, lifetime")
def test_with_card_lifetime_auth_pending_settled_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    api_post_pending_with_auth(api_request_context, auth, n, CARD_LIFETIME, PENDING, COUNTRY_US, CURRENCY_USD)
    ...
    api_post_with_auth(api_request_context, auth, n, CARD_LIFETIME, SETTLED, COUNTRY_US, CURRENCY_USD)
...
@allure.title("Transaction auth + pending + reversed check status, lifetime")
def test_with_card_lifetime_auth_pending_reversed_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    api_post_with_auth(api_request_context, auth, n, CARD_LIFETIME, REVERSAL, COUNTRY_US, CURRENCY_USD)
...
@allure.title("Transaction auth + pending + settled + refund check status, lifetime")
def test_with_card_lifetime_auth_pending_settled_refund_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    auth = send_auth(api_request_context, n, CARD_LIFETIME, '7311')
    api_post_pending_with_auth(api_request_context, auth, n, CARD_LIFETIME, PENDING, COUNTRY_GB, CURRENCY_USD)
    ...
    api_post_with_auth(api_request_context, auth, n, CARD_LIFETIME, SETTLED, COUNTRY_GB, CURRENCY_USD)
    ...
    api_post_with_auth(api_request_context, auth, n, CARD_LIFETIME, REFUND, COUNTRY_GB, CURRENCY_USD)
...
@allure.title("Transaction only auth, lifetime")
def test_with_card_lifetime_auth(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    send_auth(api_request_context, n, CARD_LIFETIME, '7311')
...
@allure.title("Transaction only settled check status, lifetime")
def test_with_card_lifetime_settled_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    api_request(api_request_context, n, CARD_LIFETIME, APPROVED_SUCCES, SETTLED, COUNTRY_GB, CURRENCY_USD)
...
@allure.title("Transaction auth settled check status, lifetime")
def test_with_card_lifetime_auth_settled_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    auth = send_auth(api_request_context, n, CARD_LIFETIME, '7311')
    api_post_with_auth(api_request_context, auth, n, CARD_LIFETIME, SETTLED, COUNTRY_GB, CURRENCY_EUR)
...
@allure.title("Transaction auth pending check status, lifetime")
def test_with_card_lifetime_auth_pending_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
...
@allure.title("Transaction auth reversed check status, lifetime")
def test_with_card_lifetime_auth_reversed_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
...
@allure.title("Transaction auth pending refund check status, lifetime")
def test_with_card_lifetime_auth_pending_refund_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
...
@allure.title("Transaction decline + auth check status, lifetime")
def test_with_card_lifetime_decline_auth_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    id = str(uuid.uuid4())
...
@allure.title("Transaction auth + settled + pending check status, lifetime")
def test_with_card_lifetime_auth_settled_pending_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
...
@allure.title("Transaction auth + reversed + pending check status, lifetime")
def test_with_card_lifetime_auth_reversed_pending_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    auth = send_auth(api_request_context, n, CARD_LIFETIME, '7311')
    api_post_with_auth(api_request_context, auth, n, CARD_LIFETIME, REVERSAL, COUNTRY_GB, CURRENCY_USD)
...
@allure.title("Transaction auth + pending + refund + settled check status, lifetime")
def test_with_card_lifetime_auth_pending_refund_settled_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    auth = send_auth(api_request_context, n, CARD_LIFETIME, '7311')
    api_post_pending_with_auth(api_request_context, auth, n, CARD_LIFETIME, PENDING, COUNTRY_GB, CURRENCY_EUR)
    ...
    api_post_with_auth(api_request_context, auth, n, CARD_LIFETIME, REFUND, COUNTRY_GB, CURRENCY_EUR)
...
@allure.title("Transaction auth + pending + reversed + settled check status, lifetime")
def test_with_card_lifetime_auth_pending_reversed_settled_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    api_post_with_auth(api_request_context, auth, n, CARD_LIFETIME, REVERSAL, COUNTRY_GB, CURRENCY_EUR)
...
@allure.title("Transaction auth + pending + settled + reversed check status, lifetime")
def test_with_card_lifetime_auth_pending_settled_reversed_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    auth = send_auth(api_request_context, n, CARD_LIFETIME, '7311')
    api_post_pending_with_auth(api_request_context, auth, n, CARD_LIFETIME, PENDING, COUNTRY_US, CURRENCY_EUR)
    ...
    api_post_with_auth(api_request_context, auth, n, CARD_LIFETIME, SETTLED, COUNTRY_US, CURRENCY_EUR)
    ...
    api_post_with_auth(api_request_context, auth, n, CARD_LIFETIME, REVERSAL, COUNTRY_US, CURRENCY_EUR)
...
@allure.title("Transaction auth + pending + settled + reversed issue expiration check status, lifetime")
def test_with_card_lifetime_auth_pending_settled_reversed_issuerexpiration_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    api_post_with_auth(api_request_context, auth, n, CARD_LIFETIME, REVERSAL_EXPIRATION, COUNTRY_US, CURRENCY_EUR)
...
@allure.title("Transaction only refund, lifetime")
def test_with_card_lifetime_only_refund(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    api_request(api_request_context, n, CARD_LIFETIME, APPROVED_SUCCES, REFUND, COUNTRY_US, CURRENCY_EUR)
...
@allure.title("Transaction auth + pending + refund + reversed check status, lifetime")
def test_with_card_lifetime_auth_pending_refund_reversed_check_status(api_request_context: APIRequestContext) -> None:
    token = auth_token(api_request_context, USER_RUBY_ROSE.login, USER_RUBY_ROSE.password)
    ...
    auth = send_auth(api_request_context, n, CARD_LIFETIME, '7311')
    api_post_pending_with_auth(api_request_context, auth, n, CARD_LIFETIME, PENDING_REFUND, COUNTRY_US, CURRENCY_EUR)
