...
from test.test_api.conftest import MC, VISA


@allure.title("Transaction auth pending settled reversed")
def test_auth_pending_settled_reversed(api_request_context: APIRequestContext) -> None:
