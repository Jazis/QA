...
@allure.title("Transaction auth reversed pending")
def test_auth_reversed_pending(api_request_context: APIRequestContext) -> None:
    token = api_post_auth_trans(api_request_context, 700, MC, '{"approved":true}')
