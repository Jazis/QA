...
@allure.title("Transaction auth pending refund settled")
def test_auth_pending_refund_settled(api_request_context: APIRequestContext) -> None:
    token = api_post_auth_trans(api_request_context, 50, MC, '{"approved":true}')
    ...
    data2 = [
        {
            ...
            "subject": "14e92235-7a12-4301-a36b-5cf00f510b14",
            "eventTime": "2023-09-26T14:45:43.1054533Z",
            "eventType": "purchase.card.return.completed",
            "dataVersion": "1"
        }
    ]
